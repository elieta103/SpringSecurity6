...
import com.elhg.security.services.CustomerUserDetails;
...
public class SecurityConfig {
    ...
    private static KeyPair generateRSA() {
        KeyPair keyPair;
        try {
            var keyPairGenerator = KeyPairGenerator.getInstance(RSA); //Algoritmo
            keyPairGenerator.initialize(RSA_SIZE); //Tamanio
            keyPair = keyPairGenerator.generateKeyPair(); //Generar
