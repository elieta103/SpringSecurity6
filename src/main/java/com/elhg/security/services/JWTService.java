...
public class JWTService {
    ...
    // Recibe el token y Devuelve los Claims(Payload)
    ...
    // Recibe los claims y una Functional Interface
    // Cuando se llama, se le pasa el token y alguna seccion del token a recuperar.
    ...
    // Recibe Claims(Payload) y el Subject(Usuario)
    ...
    public  Boolean validateToken(String token, UserDetails userDetails) {
        ...
        // Si el usuario del JWT y el de UserDetails son Iguales y no esta expirado el token. OK
